...
class VFH:
    ...
    #     #Previous waypoint location and pose
    #     xyvfh = 0
    #     psivfh = 0
    ...
    #     #Publish VFH waypoint
    #     self.pub_marker(xyvfh,psivfh)


    def pub_marker(self,xy,psi):
        ...
        self.marker.pose.position.x = xy[0]
        self.marker.pose.position.y = xy[1]
